...
package com.zyxr.bi.business.process.base;
            ...
            if (entry.getEntryType() == EntryType.ROWDATA) {
                ...
                for (RowData rowData : rowChage.getRowDatasList()) {
                    ...
                    if (eventType == EventType.INSERT) {
                        eventEntry.setEventType(com.zyxr.bi.business.model.event.EventType.INSERT);
                        eventEntry.setEventData(Collections.singletonList(makeColumn(rowData.getAfterColumnsList())));

                    } else if (eventType == EventType.DELETE) {
                        eventEntry.setEventType(com.zyxr.bi.business.model.event.EventType.DELETE);
                        eventEntry.setEventData(Collections.singletonList(makeColumn(rowData.getBeforeColumnsList())));
                    } else {
                        eventEntry.setEventType(com.zyxr.bi.business.model.event.EventType.UPDATE);
                        eventEntry.setEventData(Collections.singletonList(makeColumn(rowData.getAfterColumnsList())));
                    }
